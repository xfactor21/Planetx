      ...
      <div className="mx-auto flex w-full max-w-7xl items-stretch">
        ...
        <div className="flex flex-1 items-center justify-between gap-4 border-b border-l border-border px-4 py-2 md:px-8">
          <nav aria-label="Main" className="hidden md:block">
            <ul className="flex items-center gap-1 font-mono text-xs tracking-[0.16em] uppercase">
              {links.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="group flex items-center gap-1.5 px-3 py-2 text-muted-foreground transition-colors hover:text-foreground"
                  >
