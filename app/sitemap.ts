...
export default function sitemap(): MetadataRoute.Sitemap {
  const coreRoutes = ['', '/store', '/store/software', '/store/audio-fx', '/store/creator-resources', '/store/free', '/store/free/indie-extension-release-checklist', '/license/xupply', '/guides', '/guides/chrome-web-store-listing-checklist', '/guides/chrome-extension-screenshot-guide', '/beta', '/music', '/about', '/studyhive', '/coming-soon', '/visual-x', '/build-notes']
