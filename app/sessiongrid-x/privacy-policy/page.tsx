...
export const metadata: Metadata = {
  ...
  description: 'Standalone privacy policy for the SessionGrid X Chrome extension by planet.X.',
  alternates: {
    canonical: 'https://www.planet-x.co/sessiongrid-x/privacy-policy',
  },
}

const sectionClass = 'space-y-3 rounded-2xl border border-white/10 bg-white/[0.03] p-5 sm:p-7'

export default function SessionGridPrivacyPolicyPage() {
  return (
      ...
      <div className="mx-auto w-full max-w-4xl px-5 py-10 sm:px-8 sm:py-14">
        <header className="mb-8 border-b border-cyan-400/20 pb-7">
          ...
          <p className="mt-4 max-w-3xl text-base leading-7 text-white/70">
            This standalone policy explains how SessionGrid X handles data when you use the Chrome extension.
          </p>
        ...
        <div className="space-y-5 text-[15px] leading-7 text-white/80">
          <section className={sectionClass}>
            ...
            <p>SessionGrid X is a local-first Chrome extension for saving, organizing, restoring, and recovering browser tab sessions and workspaces.</p>
          </section>
          ...
          <section className={sectionClass}>
            ...
            <p>planet.X does not receive or remotely store your saved browsing sessions, workspace contents, or recovery snapshots in the current version.</p>
          </section>

          <section className={sectionClass}>
            <h2 className="text-xl font-bold text-white">3. Analytics, advertising, and sale of data</h2>
            <p>SessionGrid X does not include advertising SDKs or browsing analytics/telemetry SDKs. planet.X does not sell SessionGrid X user data.</p>
          </section>

          <section className={sectionClass}>
            <h2 className="text-xl font-bold text-white">4. Pro license activation</h2>
            <p>If you choose to activate SessionGrid X Pro, the extension sends the license key, a random extension/device identifier, and a signed entitlement token to planet.X solely to activate, validate, or deactivate your purchased license. planet.X sends the license key to Payhip for entitlement verification.</p>
            <p>SessionGrid X does not send your saved tab URLs, workspace contents, notes, tags, or recovery snapshots to planet.X or Payhip for license verification.</p>
          </section>
          ...
          <section className={sectionClass}>
            ...
            <p>The extension connects only to the planet.X license gateway for optional Pro entitlement verification. The Payhip product secret remains server-side and is never included in the extension.</p>
          </section>

          <section className={sectionClass}>
            <h2 className="text-xl font-bold text-white">6. Data retention and deletion</h2>
            <p>Workspace data remains in Chrome extension storage until you delete it, clear extension data, or uninstall the extension. SessionGrid X includes controls to delete saved workspaces and recovery snapshots and to export supported data for your own backup.</p>
            <p>Uninstalling SessionGrid X generally removes the extension&apos;s locally stored data from that Chrome profile, subject to Chrome&apos;s own storage behavior.</p>
          </section>

          <section className={sectionClass}>
            <h2 className="text-xl font-bold text-white">7. Third-party service</h2>
            <p>planet.X operates the license gateway, and Payhip is used only for optional paid-license entitlement verification. Payhip receives the license key but not saved workspace data. Information processed by Payhip is also governed by Payhip&apos;s privacy terms.</p>
          </section>

          <section className={sectionClass}>
            <h2 className="text-xl font-bold text-white">8. Children&apos;s privacy</h2>
            <p>SessionGrid X is a general productivity tool and is not designed to collect personal information from children.</p>
          </section>

          <section className={sectionClass}>
            <h2 className="text-xl font-bold text-white">9. Changes to this policy</h2>
            <p>If SessionGrid X materially changes how it handles data, this policy will be updated and the effective date above will be revised.</p>
          </section>
