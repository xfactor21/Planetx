      ...
      <div className="mx-auto w-full max-w-4xl px-5 py-10 sm:px-8 sm:py-14">
        ...
        <div className="space-y-5 text-[15px] leading-7 text-white/80">
          ...
          <section className={sectionClass}>
            ...
            <p>If you choose to activate SessionGrid X Pro, the license key you enter and an extension/device instance identifier may be sent to Lemon Squeezy solely to activate, validate, or deactivate your purchased license.</p>
            <p>SessionGrid X does not send your saved tab URLs, workspace contents, notes, tags, or recovery snapshots to Lemon Squeezy for license verification.</p>
          </section>
          ...
          <section className={sectionClass}>
            ...
            <p>The extension may also connect to Lemon Squeezy&apos;s license API only for optional Pro entitlement verification.</p>
          </section>
          ...
          <section className={sectionClass}>
            ...
            <p>Lemon Squeezy is used only for optional paid-license entitlement verification. Its handling of information sent to its service is governed by its own privacy terms.</p>
          </section>
