...
replace(
  ...
  "{ id: 'coming-down-that-hill', title: 'Coming Down That Hill', artist: 'xFactor', url: 'https://www.planet-x.co/music-tracks/coming-down-that-hill.mp3' }",
  'Coming Down permanent URL',
)
replace(
  "{ id: 'xs-in-my-head', title: 'Xs in My Head', artist: 'xFactor', url: './featured/xs-in-my-head.mp3' }",
  "{ id: 'xs-in-my-head', title: 'Xs in My Head', artist: 'xFactor', url: 'https://www.planet-x.co/music-tracks/xs-in-my-head.mp3' }",
  'Xs permanent URL',
)
replace(
